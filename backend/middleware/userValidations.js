const {body} = require("express-validator") // biblioteca que permite fazer estas validações
...
const userCreateValidation = () => {
    return [
        ...
        .custom((value, {req}) => { // como confirm-password não é padrão, tem que criar esta custom
